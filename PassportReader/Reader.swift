    ...
    func read() {
        ...
        if progress == 100 {
            ...
            if self.readingType == .registerPassport {
                calculatedProgress = Double(progress) + (Double(progressSOD) * 0.9)
            } else {
                calculatedProgress = Double(progress) + (Double(progressDG1) * 0.1) + (Double(progressDG2) * 0.7) + (Double(progressSOD) * 0.1)
            }
